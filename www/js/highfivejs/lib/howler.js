    ...
    Howl.prototype = {
        ...
        play: function (sprite, callback) {
            ...
            self._inactiveNode(function (node) {
                ...
                var soundId = (typeof callback === 'string') ? callback :
        ...
        pos: function (pos, id) {
            ...
            if (activeNode) {
                if (pos >= 0) {
                    ...
                    return self._webAudio ? activeNode._pos + (ctx.currentTime - self._playStart) :
        ...
        fade: function (from, to, len, callback, id) {
            var self = this, diff = Math.abs(from - to), dir = from > to ? 'down' : 'up', steps = diff /
                0.01, stepTime = len / steps;
            ...
            for (var i = 1; i <= steps; i++) {
                (function () {
                    var change = self._volume + (dir === 'up' ? 0.01 : -0.01) * i, vol = Math.round(1000 * change) /
                        1000, toVol = to;
